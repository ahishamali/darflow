                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div  class="col-md-6">
                                    <h1 class="page-header"> <i class="fa fa-download"></i> Inbox </h1>
                                </div>
                                <div  class="col-md-6">
                                    ...
                                    <div class="btn-group actions" role="group" aria-label="...">
                                        <a href="newinbox.php" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> New</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="sort-table" class="table table-striped">
                                ...
                                <tbody>
    <?php foreach ($inbox->display_latest(10) as $row) { ?>
                                        <tr>
