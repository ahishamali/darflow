...
$user_latest = $log->get_users(TRUE);
$category_latest = $cat->get_cat(TRUE);
?>
...
<table class="table table-striped">
  ...
  <th>Category</th>
   ...
   <?php  foreach ($category_latest as $row) { ?>
  <tr>
...
<a class="btn btn-default" href="categories.php">View All Category </a>
<hr>
<h3>Latest Users</h3>
<table class="table table-striped">
  <tr>
  ...
  <?php  foreach ($user_latest as $row) { ?>
  <tr>
...
<a class="btn btn-default" href="users.php">View All Users</a>
</div>
</div>
</div>
    </section>
