...
if (isset($_REQUEST['delete']) && !empty($_REQUEST['delete'])){
    $cat->delete_cat($_REQUEST['delete']);
}

$category = $cat->get_cat();
?>
...
<html lang="en">
  <head>
    ...
    <title>Darflow - Categories</title>
    <!-- Bootstrap core CSS -->
...
<div class="row">
<div  class="col-md-6">
<h1 class="page-header"><i class="glyphicon glyphicon-list-alt"></i> Categories</h1>
</div>
<div  class="col-md-6">
...
<div class="btn-group actions" role="group" aria-label="...">
    <a href="newcategories.php" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i>New</a>
</div>
</div>
</div>
<ol class="breadcrumb">
...
<table id="sort-table" class="table table-striped">
  ...
  <tbody>
   <?php foreach ($category as $row) { ?>
            ...
            <td><a href="categories.php?delete=<?php echo $row['cat_id']; ?>" style="color: red;"><i class="glyphicon glyphicon-remove"></i></a></td>
             </tr>
         <?php } ?>
  </tbody>
</table>
