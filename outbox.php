                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="list-group">
                                ...
                                <a href="outbox.php" class="list-group-item active"><i class="fa fa-upload"></i> Outbox</a>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div  class="col-md-6">
                                    <h1 class="page-header"> <i class="fa fa-upload"></i> Outbox </h1>
                                </div>
                                <div  class="col-md-6">
                                    ...
                                    <div class="btn-group actions" role="group" aria-label="...">
                                        <a href="newoutbox.php" class="btn btn-default"><i class="glyphicon glyphicon-plus"></i> New</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="sort-table" class="table table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($outbox->display_latest(10) as $row) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['create_on']; ?></td>
                                            <td><?php echo substr($row['issued_date'], 0, 10); ?></td>
