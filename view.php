                            ...
                            <div class="row">
                                <div>
                                    <fieldset> <legend>View</legend>
                                        <?php foreach ($inbox->get_by_id($_REQUEST['doc_id']) as $row) { ?>
                                            <div class="col-md-4">
                                                <h4>Doc ID:<span class="h4"><?php echo $row['doc_id']; ?></span> </h4>
                                                <h4>Title:<span class="h4"><?php echo $row['doc_title']; ?></span> </h4>
                                                <h4>Sender:<span class="h4"><?php echo $row['sender']; ?></span> </h4>
                                                <h4>Sender Name:<span class="h4"><?php echo $row['sender_name']; ?></span></h4>
                                                <h4>Created on:<span class="h4"><?php echo $row['create_on']; ?></span></h4>
                                                <h4>Comment:<span class="h4"><?php echo $row['comment']; ?></span></h4>
                                                <h4>Issued Date:<span class="h4"><?php echo substr($row['issued_date'],0,10); ?></span></h4>
                                                <h4>Replay For: <span class="h4"><a href="#">Doc ID</a></h4>

                                            </div>
                                            <div class="col-md-8">


                                                <iframe height="500" width="800" src="<?php echo $row['path']; ?>"></iframe>

                                            </div>
                                        <?php } ?>
                                        <?php foreach ($outbox->get_by_id($_REQUEST['doc_id']) as $row) { ?>
                                            <div class="col-md-4">
                                                <h4>Doc ID:<span class="h4"><?php echo $row['doc_id']; ?></span> </h4>
                                                <h4>Title:<span class="h4"><?php echo $row['doc_title']; ?></span> </h4>
                                                <h4>Recipient:<span class="h4"><?php echo $row['recipient']; ?></span> </h4>
                                                <h4>Sender Name:<span class="h4"><?php echo $row['sender_name']; ?></span></h4>
                                                <h4>Created on:<span class="h4"><?php echo $row['create_on']; ?></span></h4>
                                                <h4>Comment:<span class="h4"><?php echo $row['comment']; ?></span></h4>
                                                <h4>Issued Date:<span class="h4"><?php echo substr($row['issued_date'],0,10); ?></span></h4>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <iframe height="450" width="400" src="<?php echo $row['path']; ?>"></iframe>
