                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="list-group">
                                ...
                                <a href="categories.php" class="list-group-item active"><i class="fa fa-th"></i> Categories</a>

                            </div>
                        </div>
                        <div class="col-md-8">
                            <h1 class="page-header"> <i class="fa fa-th"></i> Categories </h1>
                            <!--start-->
                            <?php foreach ($cat->get_cat() as $row) { ?>
                            ...
                            <table class="table table-striped">
                               ...
                               <?php foreach ($inbox->get_by_cat_id($row['cat_id']) as $rows){ ?>
                                <tr>
                                    <td><?php echo $rows['doc_id']; ?></td>
                                    <td><?php echo $rows['doc_title']; ?></td>
                                    <td><?php echo $rows['create_on']; ?></td>
                                    <td><?php echo $rows['sender_name']; ?></td>
                                    <td><?php echo $rows['create_by']; ?></td>
                                    
                                </tr>
                            <?php } ?>
                                <?php foreach ($outbox->get_by_cat_id($row['cat_id']) as $rows){ ?>
                                <tr>
                                    <td><?php echo $rows['doc_id']; ?></td>
                                    <td><?php echo $rows['doc_title']; ?></td>
                                    <td><?php echo $rows['create_on']; ?></td>
